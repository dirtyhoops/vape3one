...
<body>
	...
	<div class="wrapper" id="wrapper1">
		<div class="container">
		<div class="maincontent1" id="maincontentid">
			<div class="row">
				<div id="leftnavbar" class="col-md-3">
					<div id="lefrnavbarmargin">
						...
						<div id="catergorylist">
							<ul id="categoryul">
								<li><a href="/accessories">All Accessory</a></li>
								<li><a href="/accessories/battery">Batteries</a></li>
								<li><a href="/accessories/charger">Chargers</a></li>
								<li><a href="/accessories/driptip">Drip Tips</a></li>
								<li><a href="/accessories/podsandcartridge">Pods and Cartridges</a></li>
								<li><a href="/accessories/wicksandwires">Wicks and Wires</a></li>
								<li><a href="/accessories/buildingtool">Building Tools</a></li>
								<li><a href="/accessories/coil">Replacement Coil</a></li>
								<li><a href="/accessories/etc">Etc.</a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div id="itemscontentdiv" class="col-md-9">
					<div id="itemcontainermargin">
						...
						<div id="itemscontainer">
							<div class="row">
							<c:forEach items="${allaccessories}" var="accessory">
								<div class="itembox col-lg-3 col-md-6 col-sm-6">
									<div class="itemboxpadding">
										<div class="itemimage">
										<!-- shows the admin if the item is less than 3 -->
										<c:if test="${amiadmin == 'yes' && accessory.quantity < 4 }">
										<div class="lowitemred">LOW QTY ITEM</div>
										</c:if>
											<a href="/items/${accessory.id}"><img src="${accessory.image}" alt=""></a>
											<div class="overlay">
												<div class="itemimagecontent">
													<a class="btn btn-dark btn-sm" href="/items/${accessory.id}">View Item</a>
													<!-- shows the edit and delete for admin user -->
													<c:if test="${amiadmin == 'yes'}">
														<form action="/items/${accessory.id}/deletethisitem" method="post">
															<input type="hidden" name="_method" value="delete">
				    										<input type="submit" value="Delete Item" class="btn btn-danger btn-sm">
														</form>
														<%-- <a class="btn btn-danger btn-sm" href="/items/${accessory.id}/deletethisitem">Delete Item</a> --%>
														<a class="btn btn-primary btn-sm" href="/items/${accessory.id}/editthisitem/">Edit Item</a>
													</c:if>
												</div>
											</div>
										</div>
										<p class="itemname">${accessory.name}</p>
										<p class="itemprice">$${accessory.price}</p>
									</div>
								</div> 
							</c:forEach>
